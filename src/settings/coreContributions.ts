  ...
  sections: [
    {
      ...
      properties: [
        ...
        {
          type: 'boolean',
          key: 'labs.liveCollaboration',
          title: 'Live Collaboration',
          description: 'Share a conversation room and collaborate in real time with other participants. Early access — behaviour may change.',
          default: false,
          order: 4,
        },
      ],
